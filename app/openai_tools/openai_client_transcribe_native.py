...
from openai.types.audio import Transcription, TranscriptionDiarized, TranscriptionDiarizedSegment
...
def _default_transcribe_diarize_model() -> str:
    return settings.OPENAI_MODEL_TRANSCRIBE_DIARIZE

def _default_transcribe_model() -> str:
    return settings.OPENAI_MODEL_TRANSCRIBE_STEREO
