...
def process_stereo_with_o4(left_file_cleaned: str, 
    ...
    left_cleaned_transcription = transcript_audio_file_verbose_o4_single_channel(left_file_cleaned, 
    ...
    right_cleaned_transcription = transcript_audio_file_verbose_o4_single_channel(right_file_cleaned, 
                                                                   o4_metadata_text=metadata_text)
    # if right_cleaned_transcription:
    #     print("\n" + str(right_cleaned_transcription))

    print("\n\n\n" + "="*30 + f" Transcribe O4 ORIGINAL wav " + "="*30)
    org_cleaned_transcription = transcript_audio_file_verbose_o4_stereo(org_file_cleaned, 
                                                                     o4_metadata_text=metadata_text)
