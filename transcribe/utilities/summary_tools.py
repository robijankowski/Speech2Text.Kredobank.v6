...
from openai_tools.openai_client_text import (
    async_chat_completion,  # already used
    async_chat_completion_with_format,  # NEW
)

# _default_summary_model() already exists in this file :contentReference[oaicite:2]{index=2}
